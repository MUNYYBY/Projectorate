...
async function handler(req, res) {
    ...
    try {
        const data = await _lib_prisma__WEBPACK_IMPORTED_MODULE_0__/* ["default"].ProjectDomains.findMany */ .Z.ProjectDomains.findMany();
        res.status(200).json({
            data
        });
    } catch (error) {
...
var __webpack_exports__ = (__webpack_exec__(6724));
