...
async function handler(req, res) {
    ...
    try {
        const data = await _lib_prisma__WEBPACK_IMPORTED_MODULE_0__/* ["default"].Designation.create */ .Z.Designation.create({
            data: {
        ...
        return res.status(422).json({
            Message: "Error while add new designation at backend: "
        });
    }
}
