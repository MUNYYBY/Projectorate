...
async function getProjectStatus() {
    try {
        const res = await axios.get("http://projectorate.org/api" + "/projects/get-project-status");
        return res.data;
    } catch (error) {
...
async function ChangeProjectStatus(projectId, statusId) {
    try {
        const res = await axios.post("http://projectorate.org/api" + `/projects/change-project-status?projectId=${projectId}&statusId=${statusId}`);
        return res;
    } catch (error) {
...
async function getTeamStatus() {
    try {
        const res = await axios.get("http://projectorate.org/api" + "/teams/get-team-status");
        return res.data;
    } catch (error) {
...
async function ChangeTeamStatus(teamId, statusId) {
    try {
        const res = await axios.post("http://projectorate.org/api" + `/teams/change-team-status?teamId=${teamId}&statusId=${statusId}`);
        return res;
    } catch (error) {
        console.log("Error While changing project status: ", error);
        return {
...
async function UploadWork(file) {
    ...
    try {
        const res = await axios.post("http://projectorate.org/api" + `/work-submission/upload`, formData);
        return res;
    } catch (error) {
        console.log("While uploading file:", error);
        return {
...
async function DownloadWork(url) {
    try {
        axios({
            url: "http://projectorate.org/api" + `/work-submission/download`,
            method: "GET",
            responseType: "blob",
            params: {
                url: url
...
async function SetTicketWorkSubmission(payload) {
    try {
        const res = await axios.post("http://projectorate.org/api" + `/tickets/update-work-submission`, payload);
        return res;
    } catch (error) {
